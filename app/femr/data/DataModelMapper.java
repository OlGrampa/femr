...
public class DataModelMapper implements IDataModelMapper{
     ...
     */
    @Override
    public IPatient createPatient(int userID, String firstName, String lastName, Date birthday, boolean isAgeReal, String sex, String address, String city, Integer photoID) {
